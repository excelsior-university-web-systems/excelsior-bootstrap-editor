...
add_action( 'init', function() {
    ...
    wp_register_script(
        ...
        array(),
        XCLSR_BTSTRP_FRAMEWORK_VERSION,
        array(
            'strategy' => 'defer',
            'in_footer' => true
        )
...
add_action( 'enqueue_block_editor_assets', function() {
    ...
    wp_enqueue_script(
        ...
        array( 'wp-blocks', 'wp-components', 'wp-core-data', 'wp-data', 'wp-dom-ready', 'wp-editor', 'wp-element', 'wp-format-library', 'wp-plugins', 'wp-rich-text' ),
        XCLSR_BTSTRP_EDITOR_VERSION
    );
